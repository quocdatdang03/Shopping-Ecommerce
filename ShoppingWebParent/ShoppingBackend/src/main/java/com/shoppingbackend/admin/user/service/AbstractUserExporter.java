...
public class AbstractUserExporter {
    ...
    public void setContentTypeAndExtensionFile(String contentType, String extensionFile, HttpServletResponse response) throws IOException {
        ...
        String fileName = "users_"+timestamp+extensionFile;
